...
public class Bank {
  ...
  public String returnChange(int price) {
	  ...
	  output += "Your change is " + currencyFormatter.format(change/100.0) + ": ";
  ...
  public String toString() {
    return "The machine has " + currencyFormatter.format(coinInventory.getTotalValue()) + " in the bank.";
  }//end toString
...
/**************************************************/
  private class CoinInventory {
    private HashMap<Coin, Integer> coinInventory;
    private int defaultFill = 10;
    private int totalValue = 0;
    
    //Creates a coin inventory
    //Instantiates a HashMap of Coin values
    public CoinInventory() {
      coinInventory = new HashMap<Coin, Integer>(3); //3 types of Coins
    ...
    public double getTotalValue() {
      return totalValue/100.0; //Convert coins to dollars
    }
    
    //Used by the constructor.
    //Instantiates the HashMap of coins and adds the four Coin enum values
    private void instantiateCoins() {
     coinInventory.put(Coin.QUARTER, 0);
     coinInventory.put(Coin.DIME, 0);
     coinInventory.put(Coin.NICKEL, 0);
    }

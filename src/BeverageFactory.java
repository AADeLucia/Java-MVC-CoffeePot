...
public class BeverageFactory {
    ...
    private AdditiveInventory additiveInventory;
    ...
    public String prepare(Beverage beverage, ArrayList<Additive> orderedAdditives) {
    	String output = "";
        output += "Dispensing " + beverage.getName() + "...\n";
        if(orderedAdditives != null) {
            for(Additive additive : orderedAdditives) {
                output += "Adding " + additive.getName() + "...\n";
    ...
    private void fillLists() {
        ...
        additiveList = new ArrayList<Additive>();
        additiveList.add(new Creamer());
        additiveList.add(new Lemon());
        additiveList.add(new Marshmallow());
    ...
    private class AdditiveInventory {
    	private HashMap<String, Integer> additiveInventory;
    	private int defaultFill = 3;
    		    
    	//Creates a coin inventory
    	//Instantiates a HashMap of Additive stock level
    	public AdditiveInventory() {
    		additiveInventory = new HashMap<String, Integer>();
    		this.fillStock();
    	}
    	...
    	private void fillStock() {
    		for(int i = 0; i < getAdditiveList().size(); i++) {
    			additiveInventory.put(getAdditiveList().get(i).getName(), this.defaultFill);
    		}
    	}//end fillStock
